# Generated by Django 2.1.5 on 2021-07-15 22:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ManyToManyField(default='', max_length=100, to='classroom.Department')),
                ('level', models.ManyToManyField(related_name='interested_students', to='classroom.Subject')),
            ],
        ),
        migrations.AddField(
            model_name='quiz',
